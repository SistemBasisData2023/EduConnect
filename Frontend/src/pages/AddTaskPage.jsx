...
const AddTaskPage = () => {
  return (
    <div className="w-full">
      <Header />
      <div className=" max-w-4xl mx-auto my-2 p-5 bg-white shadow-xl rounded-lg">
                ...
                <div className="col-span-full">
                  ...
                  <div className="mt-2">
                    <textarea
                      ...
                      name="about"
                      rows={3}
                      className="block w-full  bg-white rounded-md border py-1.5 text-gray-900 shadow-sm sm:text-sm sm:leading-6"
                      defaultValue={""}
                    />
                  </div>
